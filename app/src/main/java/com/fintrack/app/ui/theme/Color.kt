...
val FinTrackGreen = Color(0xFF4CAF50)      // Income / positive values / logo accent
val FinTrackRed = Color(0xFFD32F2F)        // Expenses / negative values / destructive actions
val FinTrackOrange = Color(0xFFF5A623)     // "Efectivo" tag / warnings
val FinTrackPurple = Color(0xFF8E44AD)     // "Servicios domésticos" icon tint
val FinTrackTeal = Color(0xFF17A2A0)       // "Salud y Bienestar" icon tint
